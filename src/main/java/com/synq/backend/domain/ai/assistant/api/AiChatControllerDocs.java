...
@Tag(name = "AI Chat", description = "회의 중·후 AI 채팅 API")
@SecurityRequirement(name = "bearerAuth")
public interface AiChatControllerDocs {

	@Operation(summary = "AI Chat 초기 안내 및 추천 질문 조회", description = "해당 회의가 속한 프로젝트의 멤버가 조회할 수 있다.")
	@ApiResponses({
	...
	@Operation(summary = "AI 채팅 질문 전송", description = "해당 회의가 속한 프로젝트의 멤버가 질문할 수 있다.")
	@ApiResponses({
			...
			@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "프로젝트 멤버가 아님"),
			@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "존재하지 않는 회의"),
			@io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "409", description = "clientRequestId 재사용"),
	...
	@Operation(summary = "내 AI 채팅 내역 조회", description = "해당 회의가 속한 프로젝트의 멤버가 자신의 채팅 내역을 조회할 수 있다.")
	@ApiResponses({
