...
public interface AiChatControllerDocs {
	...
	@Operation(summary = "AI Chat 초기 안내 및 추천 질문 조회", description = "진행 중인 회의에서는 현재 참여자, 종료된 회의에서는 참여 이력이 있는 사용자가 조회할 수 있다.")
	@ApiResponses({
	...
	@Operation(summary = "AI 채팅 질문 전송", description = "진행 중인 회의에서는 현재 참여자, 종료된 회의에서는 참여 이력이 있는 사용자가 질문할 수 있다.")
	@ApiResponses({
